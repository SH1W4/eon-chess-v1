...
# Ajuste: o avaliador utilizado é o AdvancedEvaluator
from src.ai.evaluation.position_evaluator import AdvancedEvaluator as AvaliadorPosicao
from src.ai.evaluation.position_evaluator import PositionalFeatures as AvaliacaoPosicao
